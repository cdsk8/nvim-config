...
vim.keymap.set("n", "td", function()
	vim.cmd.InsertTodoTag("TODO")
end, { desc = "Insert TODO comment" })
vim.keymap.set("n", "tf", function()
	vim.cmd.InsertTodoTag("FIX")
end, { desc = "Insert FIXME comment" })
vim.keymap.set("n", "tn", function()
	vim.cmd.InsertTodoTag("NOTE")
end, { desc = "Insert NOTE comment" })
vim.keymap.set("n", "th", function()
	vim.cmd.InsertTodoTag("HACK")
end, { desc = "Insert HACK comment" })
vim.keymap.set("n", "tb", function()
	vim.cmd.InsertTodoTag("BUG")
end, { desc = "Insert BUG comment" })
vim.keymap.set("n", "tp", function()
	vim.cmd.InsertTodoTag("PERF")
end, { desc = "Insert PERF comment" })
vim.keymap.set("n", "tt", function()
	vim.cmd.InsertTodoTag("TEST")
end, { desc = "Insert TEST comment" })
vim.keymap.set("n", "ti", function()
	vim.cmd.InsertTodoTag("ISSUE")
end, { desc = "Insert ISSUE comment" })
vim.keymap.set("n", "tw", function()
	vim.cmd.InsertTodoTag("WARN")
end, { desc = "Insert WARNING comment" })
vim.keymap.set("n", "tu", function()
	vim.cmd.InsertTodoTag("UPGRADE")
end, { desc = "Insert UPGRADE comment" })
...
vim.keymap.set("n", "<leader>xt", vim.cmd.terminal, { desc = "Open terminal" })
